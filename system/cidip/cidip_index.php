 ...
 */
  ...
  $cashed_path = realpath(dirname(__FILE__));
  $cashed_position = strripos($cashed_path, "system");
  $cashed_location = substr( $cashed_path, 0, $cashed_position);
  
  $system_path =  $cashed_location . "system";
  $application_folder = $cashed_location . "application";
